...
public class CamusJob extends Configured implements Tool {
  ...
  public void run(Class<? extends InputFormat> inputFormatClass,
    ...
    DateTimeZone outputTimeZone = DateTimeZone.forID(job.getConfiguration().get(ETL_DEFAULT_TIMEZONE, DEFAULT_TIME_ZONE));
    DateTimeFormatter dateFmt = DateUtils.getDateTimeFormatter("YYYY-MM-dd-HH-mm-ss",outputTimeZone);
