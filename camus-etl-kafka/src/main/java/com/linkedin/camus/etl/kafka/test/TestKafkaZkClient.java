...
//  }
	public static void main(String[] args) {
//		String timeId = "America/Los_Angeles";
//		String timeId = "Etc/GMT-8";
		String timeId = "Etc/GMT-8";
	    DateTime bucket = new DateTime();
//	    DateTimeFormatter outputDateFormatter = 	DateUtils.getDateTimeFormatter(OUTPUT_DATE_FORMAT,
//	              DateTimeZone.forID(timeId));
	    
	    DateTimeFormatter outputDateFormatter  = DateUtils.getDateTimeFormatter("'hourly'/YYYY/MM/dd/HH", DateTimeZone.forID(timeId)).withLocale(Locale.US);
	    //'hourly'/YYYY/MM/dd/HH
	    System.out.println(bucket.toString(outputDateFormatter));
	}
	  protected static final String OUTPUT_DATE_FORMAT = "YYYY-MM-dd HH:mm:ss";
}
